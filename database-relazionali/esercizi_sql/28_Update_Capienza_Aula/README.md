### Esercizio 28: Utilizzo di UPDATE per modificare i dati nelle tabelle del database
...
3. Assicurati di aver inserito i dati nella tabella `aule` come specificato negli esercizi precedenti.

# Istruzioni
Scrivere un file SQL che:
1. Aumenta la capienza dell'aula con id = 2 di 5 posti